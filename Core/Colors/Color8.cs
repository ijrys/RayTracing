using T = System.Byte;
using rgbt = Core.RGBColor8;
using rgbat = Core.RGBAColor8;
using System;
...
namespace Core {
	public struct RGBColor8 {
		public const int PixelSize = 3;

		public T R, G, B;
		public RGBColor8(T r, T g, T b) {
			R = r;
			G = g;
			B = b;
		}

		public rgbt Lerp(RGBColor8 r, Float lp) {
			return Lerp(this, r, lp);
		}

		public static rgbt Lerp(RGBColor8 l, RGBColor8 r, Float lp) {
			Float rp = 1 - lp;
	...
	public struct RGBAColor8 {
		...
		public T R, G, B, A;
		public RGBAColor8(T r, T g, T b) {
			R = r;
			G = g;
			B = b;
			A = T.MaxValue;
		}
		public RGBAColor8(T r, T g, T b, T a) {
			R = r;
			G = g;
			B = b;
			A = a;
